...
export default function FaqsFooter() {
  return (
    <div className="text-center pt-8 border-t border-orange-950/30 space-y-6">
      ...
      <div className="inline-block font-mono text-xs leading-tight text-orange-300/40 hover:text-orange-300/80 transition-colors duration-500 select-none">
        <p>+-------------------+</p>
