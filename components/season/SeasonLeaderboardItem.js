    ...
    >
      ...
      <div className="flex items-center gap-2">
        {data.scores.find((score) => score.username === username)
          ...
          <div className="w-5 h-5 rounded-full bg-orange-200 dark:bg-orange-950" />
        )}
      </div>
      <span className="text-stone-800 dark:text-stone-200">{username}</span>
      <div className="ml-auto mr-1 flex flex-row items-center gap-4">
        ...
        <div className="min-w-[24px] mr-1 text-xl text-center text-stone-900 dark:text-stone-100">
          {
            data.scores.find((score) => score.username === username)
              .cumulativePoints
          }
