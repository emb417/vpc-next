...
function updatePerformance(user, performanceWeek, type, username) {
  if (performanceWeek[type] !== 0) {
    const performanceType =
      type === "overPerformed"
        ? "annualBestPerformance"
        : "annualWorstPerformance";
...
function userSummaryData(positionWeeksData, username) {
  ...
  const annualBestPerformanceWeek = performanceWeek(
    positionWeeksData,
    username,
  ...
  const annualWorstPerformanceWeek = performanceWeek(
    positionWeeksData,
    username,
